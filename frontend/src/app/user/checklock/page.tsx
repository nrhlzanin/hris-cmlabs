  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      <div className="bg-white p-6 rounded shadow-lg">
        ...
        <input type="text" placeholder="Search Employee" className="w-full border rounded px-3 py-2 mb-4" />
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Are you sure want to approve this employee's attendance?<br />This action cannot be undone.
                  </p>
                </div>
              </div>
              <button onClick={() => setModalOpen(false)} className="text-gray-600 hover:text-black text-xl font-bold">
                &times;
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setDetailsOpen(false)} className="text-gray-600 hover:text-black text-2xl font-bold">
                &times;
              </button>
            </div>
