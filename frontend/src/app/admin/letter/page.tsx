    ...
    <div className="p-4">
      <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          />
          <button className="bg-green-600 text-white px-3 py-1 rounded text-sm" onClick={() => setShowLetterModal(true)}>
            ➕ Add Letter
          </button>
          <button className="bg-blue-600 text-white px-3 py-1 rounded text-sm" onClick={() => setShowTypeModal(true)}>
            ➕ Add Letter Type
          </button>
          <button className="bg-gray-700 text-white px-3 py-1 rounded text-sm" onClick={() => setShowTypeOverviewModal(true)}>
            📄 View Letter Types
          </button>
        </div>
      </div>
